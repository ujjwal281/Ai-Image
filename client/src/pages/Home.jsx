...
const Home = () => {
  ...
  return ( 
    ...
    <div>
        <h1 className='font-extrabold test-[#222328] text=[32px]'>The Community showcase</h1>
        ...
        {loading ? (  
          <div className='flex justify-center items-center'>
            ...
            <>
              ...
              <div className='grif lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>  
                {searchText ? (
                  <RenderCards
                    data={[]}
